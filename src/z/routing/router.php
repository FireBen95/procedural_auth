...
declare(strict_types=1);
     ...
     * attend la récection via la méthode "GET"
     *
    ...
    {
        collectRoute("GET", $request_route, $action_route);
    }

    /**
     * Cette fonction du routeur lui permet de récupérer chaque route dont l'application
     * attend la récection via la méthode "POST"
     *
     * @param string $request_route
     * @param array $action_route
     * 
    ...
    {
        collectRoute("POST", $request_route, $action_route);
    }
     ...
     * @return void
     */
    function collectRoute(string $method, string $request_route, array $action_route) : void
    {
        // Tableau de routes
        global $routes;
        $route = [];
