...
declare(strict_types=1);
    ...
    /**
     * Cette fonction vérifie si la valeur par l'utilisateur
     ...
     * existe deja dans la tale ciblée de la base données ou non.
     *
     * @param string $value
     * @param string $rule
     * @return boolean
     ...
     * envoyé par l'utilsateur est validé ou non.
     *
     * @param string $value
     * 
     * @return boolean
     */
    function email_($value) : bool
    {
    ...
    /**
     * Cette fonction vérifie si la valeur est de type châne de caractères.
     *
     * @param string $value
     * 
     * @return boolean
